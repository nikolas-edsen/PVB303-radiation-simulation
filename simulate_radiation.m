function [times, detector, logdet] = simulate_radiation(n0cs, n0ba)
% SIMULATE_RADIATION Simulate radioactive process
% Creates a simulation of the decay of 137Cs -> 137mBa -> 137Ba with a
% given input of the initial numbers of Cs and Ba atoms
